...
from utilities.utilities import AddBias
...
class SplitBias(nn.Module):
    def __init__(self, module):
        ...
        self.module = module
        assert hasattr(module.bias, 'data')
    ...
    def _prepare_model(self):
        for module in self.model.modules():
            ...
            if classname in self.known_modules:
                ...
                # print("unknown module skipped: {}".format(classname))
                pass
    ...
    def step(self):
        ...
        for _name, p in self.model.named_parameters():
            if p in updates.keys():
                ...
                # print("step update skipped: {}".format(_name))
                pass
